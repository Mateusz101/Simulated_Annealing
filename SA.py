...
best_distance, best_route, best_global = runSimulatedAnnealingMultipleTimes(
    matrix, num_runs=16, initial_temperature=1000, cooling_rate=0.003,
    num_iterations=100, acc_value=400000, min_temp=10, temp_red='fast', method="insertion",
    filename=f"Wyzarzanie_records_testy1.txt")
